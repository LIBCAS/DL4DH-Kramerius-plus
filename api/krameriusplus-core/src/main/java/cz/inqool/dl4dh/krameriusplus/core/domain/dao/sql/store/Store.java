...
import cz.inqool.dl4dh.krameriusplus.core.domain.dao.sql.Result;
import cz.inqool.dl4dh.krameriusplus.core.domain.dao.sql.object.DomainObject;
import cz.inqool.dl4dh.krameriusplus.core.domain.dao.sql.params.Filter;
...
public interface Store<T extends DomainObject, Q extends EntityPathBase<T>> {
     ...
     */
    Result<T> listAll(@NonNull Params params);
     ...
     * @return collection of found instances
     */
    Result<T> listAll(int page, int pageSize, List<Filter> filters);
     ...
     * @return collection of found instances
     */
    Result<T> listAll(int page, int pageSize, List<Filter> filters, boolean loadLazyCollections);
     ...
     * @return collection of found instances
     */
    Result<T> listAllSorted(String sortByAttribute, Order order, List<Filter> filters, boolean loadLazyCollections);
     ...
     * @return collection of found instances
     */
    Result<T> listAllSorted(String sortByAttribute, Order order, int page, int pageSize, List<Filter> filters, boolean loadLazyCollections);
