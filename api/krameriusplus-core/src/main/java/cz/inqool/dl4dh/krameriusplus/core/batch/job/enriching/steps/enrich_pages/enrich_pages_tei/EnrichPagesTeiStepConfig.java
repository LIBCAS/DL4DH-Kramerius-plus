package cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.enrich_pages.enrich_pages_tei;
...
import static cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.EnrichingSteps.EnrichPagesTei.STEP_NAME;
...
public class EnrichPagesTeiStepConfig {
    ...
    @Resource(name = EnrichingSteps.EnrichPagesTei.PROCESSOR_NAME)
