...
import static cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.Steps.DownloadPagesAltoStep.STEP_NAME;
...
public class DownloadPagesAltoStepConfig {
    ...
    @Resource(name = Steps.DownloadPagesAltoStep.PROCESSOR_NAME)
