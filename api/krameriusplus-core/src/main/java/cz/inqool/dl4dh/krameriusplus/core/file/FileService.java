...
//    }
    ...
    public FileRef create(InputStream stream, long size, String name, String contentType) {
        Utils.notNull(stream, () -> new IllegalArgumentException("Stream cannot be null"));
        Utils.notNull(contentType, () -> new IllegalArgumentException("ContentType cannot be null"));
        Utils.notNull(name, () -> new IllegalArgumentException("Name cannot be null"));
