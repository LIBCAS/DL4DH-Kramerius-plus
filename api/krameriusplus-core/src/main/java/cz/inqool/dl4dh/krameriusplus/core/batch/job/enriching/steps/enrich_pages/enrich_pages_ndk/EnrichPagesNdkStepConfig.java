package cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.enrich_pages.enrich_pages_ndk;
...
import static cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.EnrichingSteps.EnrichPagesNdk.STEP_NAME;

@Configuration
public class EnrichPagesNdkStepConfig {
    ...
    @Resource(name = EnrichingSteps.EnrichPagesNdk.PROCESSOR_NAME)
