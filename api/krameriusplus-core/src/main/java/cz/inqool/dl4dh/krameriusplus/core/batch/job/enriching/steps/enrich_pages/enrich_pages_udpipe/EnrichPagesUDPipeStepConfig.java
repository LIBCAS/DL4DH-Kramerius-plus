...
import static cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.EnrichingSteps.EnrichPagesUDPipe.STEP_NAME;

@Configuration
public class EnrichPagesUDPipeStepConfig {
    ...
    @Resource(name = EnrichingSteps.EnrichPagesUDPipe.PROCESSOR_NAME)
