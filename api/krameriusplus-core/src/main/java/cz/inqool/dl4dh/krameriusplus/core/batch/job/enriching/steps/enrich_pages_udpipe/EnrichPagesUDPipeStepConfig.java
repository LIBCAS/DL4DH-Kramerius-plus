...
import static cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.Steps.EnrichPagesUDPipe.STEP_NAME;
...
public class EnrichPagesUDPipeStepConfig {
    ...
    @Resource(name = Steps.EnrichPagesUDPipe.PROCESSOR_NAME)
