...
public enum KrameriusJob {
    ...
    ENRICHMENT_TEI(ENRICHMENT_QUEUE.getQueueName(), Set.of(ENRICHMENT_KRAMERIUS)),

    EXPORT_JSON(EXPORT_QUEUE.getQueueName(), Set.of(ENRICHMENT_KRAMERIUS)),
    EXPORT_CSV(EXPORT_QUEUE.getQueueName(), Set.of(ENRICHMENT_KRAMERIUS)),
    EXPORT_TEI(EXPORT_QUEUE.getQueueName(), Set.of(ENRICHMENT_KRAMERIUS, ENRICHMENT_TEI)),
