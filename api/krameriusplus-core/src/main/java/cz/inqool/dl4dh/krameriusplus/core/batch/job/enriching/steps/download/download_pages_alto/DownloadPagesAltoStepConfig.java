package cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.download.download_pages_alto;
...
import static cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.EnrichingSteps.DownloadPagesAltoStep.STEP_NAME;

@Configuration
public class DownloadPagesAltoStepConfig {
    ...
    @Resource(name = EnrichingSteps.DownloadPagesAltoStep.PROCESSOR_NAME)
