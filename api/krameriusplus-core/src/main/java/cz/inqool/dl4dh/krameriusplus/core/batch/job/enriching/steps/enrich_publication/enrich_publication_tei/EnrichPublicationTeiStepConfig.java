package cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.enrich_publication.enrich_publication_tei;
...
import static cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.EnrichingSteps.EnrichPublicationTei.STEP_NAME;

@Configuration
public class EnrichPublicationTeiStepConfig {
    ...
    @Resource(name = EnrichingSteps.EnrichPublicationTei.PROCESSOR_NAME)
