...
import cz.inqool.dl4dh.krameriusplus.corev2.digitalobject.page.LinguisticMetadata;
...
import static cz.inqool.dl4dh.krameriusplus.corev2.config.WebClientConfig.UD_PIPE_WEB_CLIENT;
...
public class UDPipeEnricher {
    ...
    @Autowired
    public void setWebClient(@Qualifier(UD_PIPE_WEB_CLIENT) WebClient webClient) {
