...
import cz.inqool.dl4dh.krameriusplus.core.domain.jpa.PersistenceException;
...
public abstract class DomainStore<T extends DomainObject, Q extends EntityPathBase<T>> extends SimpleJpaRepository<T, String> {
    ...
    private Q constructQObject(Class<T> type, Class<Q> qType) {
        ...
        try {
            ...
            throw new PersistenceException("Error creating Q object for + " + type.getName(), PersistenceException.PersistenceErrorCode.QUERY_DSL, FATAL_ERROR);
        }
    }
