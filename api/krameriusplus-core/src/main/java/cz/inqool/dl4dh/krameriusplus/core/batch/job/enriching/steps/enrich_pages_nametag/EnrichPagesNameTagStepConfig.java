package cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.enrich_pages_nametag;
...
import static cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.Steps.EnrichPagesNameTag.STEP_NAME;
...
public class EnrichPagesNameTagStepConfig {
    ...
    @Resource(name = Steps.EnrichPagesNameTag.PROCESSOR_NAME)
