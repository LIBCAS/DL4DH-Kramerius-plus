...
import static cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.Steps.EnrichPagesNdk.STEP_NAME;
...
public class EnrichPagesNdkStepConfig {
    ...
    @Resource(name = Steps.EnrichPagesNdk.PROCESSOR_NAME)
