...
import static cz.inqool.dl4dh.krameriusplus.core.batch.job.enriching.steps.Steps.EnrichPublicationTei.STEP_NAME;
...
public class EnrichPublicationTeiStepConfig {
    ...
    @Resource(name = Steps.EnrichPublicationTei.PROCESSOR_NAME)
