...
public enum KrameriusJobType {
    CREATE_ENRICHMENT_REQUEST(KrameriusJobTypeName.CREATE_ENRICHMENT_REQUEST, DEFAULT_QUEUE),
    CREATE_EXPORT_REQUEST(KrameriusJobTypeName.CREATE_EXPORT_REQUEST, DEFAULT_QUEUE),

    ENRICHMENT_EXTERNAL(KrameriusJobTypeName.ENRICHMENT_EXTERNAL, ENRICHMENT_QUEUE),
    ENRICHMENT_NDK(KrameriusJobTypeName.ENRICHMENT_NDK, ENRICHMENT_QUEUE),
    ENRICHMENT_TEI(KrameriusJobTypeName.ENRICHMENT_TEI, ENRICHMENT_QUEUE),
