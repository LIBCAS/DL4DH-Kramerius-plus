...
import cz.inqool.dl4dh.krameriusplus.corev2.digitalobject.page.NamedEntity;
...
import static cz.inqool.dl4dh.krameriusplus.corev2.config.WebClientConfig.NAME_TAG_WEB_CLIENT;
...
public class NameTagEnricher {
    ...
    @Autowired
    public void setWebClient(@Qualifier(NAME_TAG_WEB_CLIENT) WebClient webClient) {
