...
import cz.inqool.dl4dh.krameriusplus.service.system.job.config.export.alto.components.PageAltoWriter;
...
public class ExportPagesAltoStepFactory extends FlowStepFactory<Page, Page> {
    ...
    private final PageAltoWriter writer;

    @Autowired
    public ExportPagesAltoStepFactory(PageMongoReader reader, PageAltoWriter writer) {
        this.reader = reader;
        this.writer = writer;
    }
