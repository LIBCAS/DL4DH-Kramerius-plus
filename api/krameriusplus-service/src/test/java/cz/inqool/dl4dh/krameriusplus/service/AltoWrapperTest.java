...
public class AltoWrapperTest {
    ...
    public void testExtractStringFromAlto() {
        String pageId = "uuid:189d4d39-8862-4bb8-9e51-b7d914a4087a";

        AltoWrapper altoWrapper = new AltoWrapper(streamProvider.getAlto(pageId));

        String actual = altoWrapper.extractPageContent();
