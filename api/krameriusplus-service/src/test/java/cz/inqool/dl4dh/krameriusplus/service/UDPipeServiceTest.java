...
public class UDPipeServiceTest {
    ...
    public void testTokenize() {
        Page page = new Page();
        page.setContent("Pojedeme k babičce, abychom se najedli.");
    ...
    private Monograph prepareMonographDto() {
        ...
        page.setContent("í ikat od rodičů i od žáků, a v té důminoe, že se\n" +
        ...
        page.setContent("kleknul před křížem a předříkával nám krátké\n" +
        ...
        page.setContent("učil malé děti ve zvláštní světnici. Já seděla v tře-\n" +
